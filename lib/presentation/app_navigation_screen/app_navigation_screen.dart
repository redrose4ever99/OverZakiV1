...
class AppNavigationScreen extends StatelessWidget {
  ...
  /// Navigates to the frameOne1Screen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `Navigator` widget
  /// to push the named route for the frameOne1Screen.
  onTapFrameOne1(BuildContext context) {
    Navigator.pushNamed(context, AppRoutes.frameOne1Screen);
  }
}
